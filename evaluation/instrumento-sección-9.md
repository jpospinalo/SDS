...
Esta sección presenta las propiedades físicas y químicas básicas del producto y, cuando aparecen, otras características de seguridad consignadas en la propia Sección 9.
...
|---|---|---|---|---|---|---|
| 9.0 | Título de la sección | **A4.3.9** | (1) La FDS presenta una sección identificable como **Sección 9**. (2) El encabezado contiene una de las siguientes expresiones: **Propiedades físicas y químicas** o **Propiedades físicas y químicas y características de seguridad**. | Se observan los dos atributos. | Se observa solo uno de los dos atributos. | No se observa ningún atributo. |
...
## 9.4. Punto de fusión / punto de congelación
...
## 9.5. Punto de ebullición o punto de ebullición inicial e intervalo de ebullición
...
## 9.7. Límites inferior y superior de explosión/inflamabilidad
...
## 9.9. Temperatura de ignición espontánea
...
## 9.10. Temperatura de descomposición
...
## 9.14. Coeficiente de reparto n-octanol/agua (valor logarítmico)
...
## 9.16. Densidad y/o densidad relativa
...
## 9.17. Densidad de vapor relativa
...
## 9.18. Características de las partículas
...
## Criterio general
La asignación de **5, 3 o 1** se realiza únicamente con base en **atributos observables en la propia Sección 9 de la FDS**.
...
- Una referencia aislada a otra sección, por ejemplo **ver sección 2** o **véase sección 2**, no satisface un atributo de contenido.
- Las expresiones aceptadas de no aplicabilidad o falta de datos son solo las siguientes: **no se aplica**, **N/A**, **NA**, **no disponible**, **no disponibles**, **N/D** y **ND**.
...
- En este instrumento, la categoría **No corresponde** no se usa para los ítems **9.1 a 9.18**.
- Cuando una propiedad básica no aplica o no hay datos, la propia Sección 9 debe incluir el campo y consignar una de las expresiones aceptadas de no aplicabilidad o falta de datos definidas en este instrumento.
- La ausencia del campo no se transforma en **No corresponde**.
...
## 9.5
- Para este ítem, además del valor numérico con unidad de temperatura, se aceptan solo las siguientes expresiones literales: **se descompone antes de hervir** y **no se observó ebullición hasta** seguida de un valor con unidad de temperatura.

## 9.7
- Para este ítem, se aceptan como unidades o símbolos de concentración: **%**, **% v/v**, **%vol**, **vol%** y **ppm**.

## 9.8
- Para este ítem, se aceptan como unidades de temperatura: **°C**, **ºC**, **°F** y **ºF**.
- La presencia de un método, por ejemplo **vaso abierto** o **vaso cerrado**, se registra en **Observaciones**.

## 9.9
- Para este ítem, se aceptan como unidades de temperatura: **°C**, **ºC**, **°F** y **ºF**.

## 9.10
- Para este ítem, además del valor numérico con unidad de temperatura, se acepta solo la expresión literal **no se observó descomposición hasta** seguida de un valor con unidad de temperatura.

## 9.12
- Para este ítem, se aceptan como unidades de viscosidad cinemática: **mm²/s**, **mm2/s**, **cSt** y **centistokes**.
- Si la FDS usa solo **viscosidad** y no contiene de forma expresa **cinemática**, el atributo 1 se observa y el atributo 2 no se observa, aun cuando el campo contenga una de las expresiones aceptadas de no aplicabilidad o falta de datos definidas en este instrumento.

## 9.15
- Para este ítem, se aceptan como unidades de presión: **Pa**, **kPa**, **hPa**, **mbar**, **bar**, **mmHg** y **psi**.
...
- Un texto sobre forma, relación de aspecto o superficie específica sin un número y sin una unidad de tamaño no satisface el atributo 2.
...
- En caso de duda entre **3** y **1**, asignar **1**.
- La información suplementaria de las **Tablas A4.3.9.2** y **A4.3.9.3** puede anotarse en **Observaciones**, pero no cambia por sí sola la calificación de los ítems **9.1 a 9.18**.
...
```text
Item_9_0 Calidad_9_0 Item_9_1 Calidad_9_1 Item_9_2 Calidad_9_2 Item_9_3 Calidad_9_3 Item_9_4 Calidad_9_4 Item_9_5 Calidad_9_5 Item_9_6 Calidad_9_6 Item_9_7 Calidad_9_7 Item_9_8 Calidad_9_8 Item_9_9 Calidad_9_9 Item_9_10 Calidad_9_10 Item_9_11 Calidad_9_11 Item_9_12 Calidad_9_12 Item_9_13 Calidad_9_13 Item_9_14 Calidad_9_14 Item_9_15 Calidad_9_15 Item_9_16 Calidad_9_16 Item_9_17 Calidad_9_17 Item_9_18 Calidad_9_18
```
